...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
    ...
    @NonNull private SortMethod sortMethod = SortMethod.NONE; //The sort method to be used to display tasks

    @Nullable public AlertDialog dialog = null; //Dialog to create a new task

    @Nullable private EditText dialogEditText = null; //EditText that allows user to set the name of a task

    @Nullable private Spinner dialogSpinner = null; //Spinner that allows the user to associate a project to a task

    // Suppress warning is safe because variable is initialized in onCreate
    @SuppressWarnings("NullableProblems")
    @NonNull private RecyclerView listTasks; //The RecyclerView which displays the list of tasks

    // Suppress warning is safe because variable is initialized in onCreate
    @SuppressWarnings("NullableProblems")
    @NonNull private TextView lblNoTasks; //The TextView displaying the empty state
    ...
    // utilisation de la factory pour creer le viewmodel
    ...
    public void onDeleteTask(Task task) {
        projectAndTaskViewModel.deleteTask(task);
    }
